                    ...
                    <div class="col-lg-6 col-sm-12 mb-3">
                        ...
                        <div id="specialities"  aria-describedby="describeSpecialtiesField">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="speciality[]" value="{{$develop_class->id}}" id="speciality{{$loop->iteration}}" {{ $developer->speciality && in_array($develop_class->id, old('speciality', $developer->speciality)) ? "checked" : "" }}>
