...
@section('content')
    <div class="d-flex justify-content-between mb-3">
        <h4 class="brand-text text-primary ms-1"><b>Comercializadoras</b></h4>
        <a href="{{route('admin.brokers.create')}}" class="btn btn-primary btn-sm">
...
<script>
  	$(document).ready( function () {
                ...
                $.confirm({
                    ...
                    buttons: {
                        ...
                        confirmar: {
                            ...
                            action: function () {
                                var url = "{{route('admin.brokers.destroy',':id')}}";
        ...
        $("table tbody tr .record-edit").on("click", function(e) {
            var tr = $( this ).closest('tr');
            var id = tr.attr('data-id');
            var url = "{{route('admin.brokers.edit',':id')}}";
