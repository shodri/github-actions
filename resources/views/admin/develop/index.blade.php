...
@section('content')
    <div class="d-flex justify-content-between mb-3">
        <h4 class="brand-text text-primary ms-1"><b>Desarrollos</b></h4>
        <a href="{{route('admin.develops.create')}}" class="btn btn-primary btn-sm">
            Nuevo Desarrollo
        </a>
    </div>
  	...
  	$(document).ready( function () {
        ...
        $("table tbody tr .record-delete").on("click", function(e){
            ...
            if(id) {
                $.confirm({
                    title: 'Confirmar',
                    content: 'Seguro que desea eliminar los datos del desarrollo &lt;' + tr.children()[0].innerText + '&gt;?',
                    type: 'red',
                    closeIcon: true,
                    buttons: {
                        cancelar: {
                        ...
                        confirmar: {
                            ...
                            action: function () {
                                var url = "{{route('admin.develops.destroy',':id')}}";
        ...
        $("table tbody tr .record-edit").on("click", function(e) {
            var tr = $( this ).closest('tr');
            var id = tr.attr('data-id');
            var url = "{{route('admin.develops.edit',':id')}}";
